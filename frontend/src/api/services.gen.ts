 ...
 */
export const itemGetActive = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
 ...
 * Get auction report
 */
export const adminAuctionReport = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
 ...
 * Get forensic report
 */
export const adminForensicReport = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
...
/**
 * Check and update if item is expired or not.
 */
export const itemCheckExpired = <ThrowOnError extends boolean = false>(options: Options<ItemCheckExpiredData, ThrowOnError>) => {
    return (options?.client ?? client).post<ItemCheckExpiredResponse, ItemCheckExpiredError, ThrowOnError>({
        ...options,
        url: '/api/items/{itemId}/check-expired'
    });
};
 ...
 * Get user fund
 */
export const userFund = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<UserFundResponse, UserFundError, ThrowOnError>({
        ...options,
        url: '/api/profile/fund'
    });
};
 ...
 * Get all users
 */
export const adminUsers = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<AdminUsersResponse, AdminUsersError, ThrowOnError>({
        ...options,
        url: '/api/admin/users'
    });
};
 ...
 * Get all bids
 */
export const adminBids = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<AdminBidsResponse, AdminBidsError, ThrowOnError>({
        ...options,
        url: '/api/admin/bids'
    });
};