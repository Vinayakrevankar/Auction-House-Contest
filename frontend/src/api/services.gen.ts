 ...
 * Create a seller account
 */
export const postApiSellersRegister = <ThrowOnError extends boolean = false>(options: Options<PostApiSellersRegisterData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiSellersRegisterResponse, PostApiSellersRegisterError, ThrowOnError>({
        ...options,
 ...
 */
export const postApiBuyersRegister = <ThrowOnError extends boolean = false>(options: Options<PostApiBuyersRegisterData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiBuyersRegisterResponse, PostApiBuyersRegisterError, ThrowOnError>({
        ...options,
        url: '/api/buyers/register'
    });
};
