...
/**
 * Get funds from user profile
 */
export const profileFunds = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ProfileFundsResponse, ProfileFundsError, ThrowOnError>({
        ...options,
        url: '/api/get-user-funds'
    });
};