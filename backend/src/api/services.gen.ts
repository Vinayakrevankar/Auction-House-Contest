...
export const postApiLogin = <ThrowOnError extends boolean = false>(options: Options<PostApiLoginData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiLoginResponse, PostApiLoginError, ThrowOnError>({
        ...options,
        url: '/api/login'
    });
};
 ...
 * Register a new user
 */
export const postApiRegister = <ThrowOnError extends boolean = false>(options: Options<PostApiRegisterData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiRegisterResponse, PostApiRegisterError, ThrowOnError>({
        ...options,
        url: '/api/register'
    });
};
...
export const postApiUploadImage = <ThrowOnError extends boolean = false>(options: Options<PostApiUploadImageData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiUploadImageResponse, PostApiUploadImageError, ThrowOnError>({
        ...options,
 ...
 */
export const getApiItemsActive = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiItemsActiveResponse, GetApiItemsActiveError, ThrowOnError>({
        ...options,
...
/**
 * Get bids related to item
 */
export const getApiItemsByItemIdBids = <ThrowOnError extends boolean = false>(options: Options<GetApiItemsByItemIdBidsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiItemsByItemIdBidsResponse, GetApiItemsByItemIdBidsError, ThrowOnError>({
        ...options,
